        ...
        <div class="container">
            <form id="form-persona">
                <div class="row alinear-form">
                    ...
                    <?php if(!empty($oCarrito->envio) && $oCarrito->envio->idCostoEnvioZona != 1): ?>
                        <div class="col-md-6 col-lg-5 p-md-3 p-sm-0 alinear-col">
                            <div class="row titulo-seccion">
                    ...
                    <div class="col-lg-5 col-md-6 p-md-3 alinear-col">
                        ...
                        <div class="col-sm-6 pl-sm-4">
                            <a type="submit" href="<?php echo e(url('setPersona')); ?>" id="btn-pago-paso2" class="siguiente-carrito">CONTINUAR 
                                <img src="<?php echo e(asset('images/iconos/siguiente.png')); ?>" alt="">
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppOK\htdocs\centro-del-peinador\resources\views/carrito/datos.blade.php ENDPATH**/ ?>