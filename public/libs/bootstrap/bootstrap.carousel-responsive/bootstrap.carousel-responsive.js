(Sawubona.carousel = function(){
	...
	for(var i = 0; i < this.carousels.length; i++){
		...
		var cantidad =(width >= 1200) ? (setItems[4] != undefined ? setItems[4] : 5) : (width >= 769) ? (setItems[3] != undefined ? setItems[3] : 4) : ((width >= 576) ? (setItems[2] != undefined ? setItems[2] : 3) : ((width >= 481) ? (setItems[1] != undefined ? setItems[1] : 2) : (setItems[0] != undefined ? setItems[0] : 1) ));
